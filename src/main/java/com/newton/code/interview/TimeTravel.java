...
public class TimeTravel {
    ...
    private static String get(String name, long timeInMilli) {
        ...
        if (res == null) {
            System.out.println("Name : " + name + "\tGiven time : " + timeInMilli + "\t Obtained time : " + "\t City :" + null);
            return null;
        }
        System.out.println("Name : " + name + "\tGiven time : " + timeInMilli + "\t Obtained time : " + res.getKey() + "\t City :" + res.getValue());
        return res.getValue();
    }
